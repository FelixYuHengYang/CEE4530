...
Figure 3 shows a sample graph of model and experimental data vs time for the flow rate of 500 $\mu mol/s$. The blue dots representing the discrete observed data is very close to the red line representing the theoretical model. This is despite factors such as the low depth of reactor, and low efficiency of the system delivering oxygen, which would have not been accounted for in the model equation.
